...
const AddItem: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = { title, date, time, notes };
  ...
  return (
   <div className="">
    <div className="max-w-lg mx-auto shadow-2xl bg-gradient-to-br from-slate-50  to-blue-50 overflow-hidden p-6 \ rounded-2xl border border-gray-200 mt-30">
