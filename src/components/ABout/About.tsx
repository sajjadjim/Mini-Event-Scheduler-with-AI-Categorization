      ...
      <div className="relative z-10 space-y-20 w-full max-w-7xl mx-auto px-4 pt-20 pb-32">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed mb-8 animate-fade-in-up animation-delay-500">
              Easy Sub delivers a curated subscription box filled with exciting products from local businesses, tailored just for you.
              It's all about discovering new favorites and supporting the community.
            </p>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              { icon: "💡", title: "Innovative Solutions", desc: "We create custom-tailored subscription boxes that bring joy and excitement while providing new experiences each month.", delay: "0s" },
              { icon: "👥", title: "Community-Focused", desc: "Supporting local businesses is at the heart of our service, and we foster a thriving marketplace for customers and vendors.", delay: "0.2s" },
              { icon: "🏆", title: "Top Quality", desc: "Each box is curated with only the best products, ensuring quality, value, and satisfaction in every delivery.", delay: "0.4s" }
            ].map((item, index) => (
              <div 
                key={index}
        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-8 px-8">
            {[
              ...
              >
                <div className="text-3xl text-emerald-500 group-hover:scale-110 transition-transform duration-300">
                  ✔️
                </div>
        ...
        >
          <h2 className="text-4xl font-bold mb-16 bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent">
            What Our Customers Say
          </h2>
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
            {[
              { text: "I look forward to my Easy Sub box every month. The items are always thoughtful and a great mix of new and familiar products!", author: "Jessica Smith", delay: "0s" },
              { text: "Easy Sub has introduced me to so many fantastic local products. It's like getting a surprise gift every month!", author: "Michael Brown", delay: "0.3s" }
              ...
              >
                <div className="text-4xl text-rose-400 mb-4 group-hover:scale-110 transition-transform duration-300">
                  "
                </div>
        ...
        >
          <div className="absolute inset-0 bg-black opacity-10 rounded-3xl"></div>
          <div className="relative z-10">
            <h2 className="text-4xl font-bold mb-8 animate-pulse-subtle">
              Join the Easy Sub Family
            </h2>
